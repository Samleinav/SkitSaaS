...
export const EXTERNAL_MODULE_META = [
  ...
  { moduleId: "mod.example.portal", mode: "source-host", entry: "@/modules/mod.example.portal/src/manifest", sdkRange: "^1.5.0", sdkCompatible: true, templatePack: null, db: null },
