...
import mod_mod_artificial_scientist from '@/modules/mod.artificial.scientist/src/manifest';
...
export const EXTERNAL_MODULES: ModuleManifest[] = [
  mod_mod_artificial_scientist, mod_mod_commerce_one_time_payments, mod_mod_commerce_products, mod_mod_example_admin, mod_mod_example_api, mod_mod_example_dashboard, mod_mod_example_package, mod_mod_example_portal, mod_mod_example_suite
];

export const EXTERNAL_MODULE_META = [
  { moduleId: "mod.artificial.scientist", mode: "source-host", entry: "@/modules/mod.artificial.scientist/src/manifest", sdkRange: "^1.7.1", sdkCompatible: true, templatePack: null, db: {"schemaVersion":1,"migrationsDir":"modules/mod.artificial.scientist/db/migrations"} },
