...
export const EXTERNAL_MODULE_META = [
  ...
  { moduleId: "mod.example.admin", mode: "source-host", entry: "@/modules/mod.example.admin/src/manifest", sdkRange: "^1.3.5", sdkCompatible: true, templatePack: null, db: null },
  { moduleId: "mod.example.api", mode: "source-host", entry: "@/modules/mod.example.api/src/manifest", sdkRange: "^1.3.5", sdkCompatible: true, templatePack: null, db: null },
  { moduleId: "mod.example.dashboard", mode: "source-host", entry: "@/modules/mod.example.dashboard/src/manifest", sdkRange: "^1.3.5", sdkCompatible: true, templatePack: null, db: null },
  { moduleId: "mod.example.package", mode: "source-package", entry: "@/modules/mod.example.package/dist/manifest", sdkRange: "^1.3.5", sdkCompatible: true, templatePack: {"defaultEntryPath":"modules/mod.example.package/dist/templates/defaults.json","overrideEntryPath":"modules/mod.example.package/dist/templates/overrides.json","contractRange":"^1.0.0"}, db: {"schemaVersion":1,"migrationsDir":"modules/mod.example.package/db/migrations"} },
  { moduleId: "mod.example.suite", mode: "source-host", entry: "@/modules/mod.example.suite/src/manifest", sdkRange: "^1.3.5", sdkCompatible: true, templatePack: {"defaultEntryPath":"modules/mod.example.suite/src/templates/defaults.json","overrideEntryPath":"modules/mod.example.suite/src/templates/overrides.json","contractRange":"^1.0.0"}, db: {"schemaVersion":1,"migrationsDir":"modules/mod.example.suite/db/migrations"} }
];
