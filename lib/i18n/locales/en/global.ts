...
const messages = {
  ...
  pricing: {
    ...
    userPlansDescription: 'Plans designed for individual users and personal workspaces.',
    organizationPlansTitle: 'Organization plans',
    organizationPlansDescription: 'Plans designed for teams and collaborative organizations.',
    ...
    selfServiceUnavailableLabel: 'Self-service checkout for this plan scope is not available yet.',
    intervals: {
      daily: 'day',
      weekly: 'week',
      monthly: 'month',
