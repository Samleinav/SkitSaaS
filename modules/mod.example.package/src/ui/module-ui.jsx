...
export function DataTable({ headers, rows }) {
  return (
    <div className="example-package-table-wrap">
      <table className="example-package-table">
        <thead>
          <tr>
            {headers.map((header) => (
              <th key={header} className="example-package-table-head-cell">
                {header}
              </th>
            ))}
          </tr>
        ...
        <tbody>
          {rows.map((cells, rowIndex) => (
            <tr key={rowIndex} className="example-package-table-row">
              {cells.map((cell, cellIndex) => (
                <td
                  key={`${rowIndex}-${cellIndex}`}
                  className="example-package-table-cell"
                >
                  {cell}
                </td>
              ))}
