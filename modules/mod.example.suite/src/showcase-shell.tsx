...
.example-suite-data-table {
  display: grid;
  gap: 0.85rem;
}

.example-suite-data-table .sdk-data-table__header,
.example-suite-data-table .sdk-data-table__toolbar,
.example-suite-data-table .sdk-data-table__pagination {
  display: flex;
  align-items: center;
...
.example-suite-data-table .sdk-data-table__header-title {
  margin: 0;
  font-size: 1rem;
  font-weight: 700;
}

.example-suite-data-table .sdk-data-table__header-description,
...
.example-suite-data-table .sdk-data-table__toolbar-filters,
.example-suite-data-table .sdk-data-table__pagination-actions,
.example-suite-data-table .sdk-data-table__cell-actions,
.example-suite-data-table .sdk-data-table__confirm-actions {
  display: flex;
  align-items: center;
  gap: 0.5rem;
  flex-wrap: wrap;
...
.example-suite-data-table .sdk-data-table__filter,
.example-suite-data-table .sdk-data-table__pagination-page-size {
  display: inline-flex;
  align-items: center;
  gap: 0.4rem;
}

.example-suite-data-table .sdk-data-table__toolbar-search,
.example-suite-data-table .sdk-data-table__filter input,
.example-suite-data-table .sdk-data-table__filter select,
...
.example-suite-data-table .sdk-data-table__table {
  width: 100%;
  border-collapse: collapse;
}

.example-suite-data-table .sdk-data-table__table th {
...
.example-suite-data-table .sdk-data-table__sort-indicator {
  opacity: 0.72;
}

.example-suite-data-table .sdk-data-table__cell-actions a,
.example-suite-data-table .sdk-data-table__cell-actions button,
.example-suite-data-table .sdk-data-table__header-actions a,
.example-suite-data-table .sdk-data-table__header-actions button,
.example-suite-data-table .sdk-data-table__toolbar-actions a,
.example-suite-data-table .sdk-data-table__toolbar-actions button,
.example-suite-data-table .sdk-data-table__pagination-actions button,
.example-suite-data-table .sdk-data-table__confirm-actions button {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-height: 2rem;
