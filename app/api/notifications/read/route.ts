...
import { markNotificationsReadForUser } from '@/lib/notifications/service';
import {
...
export const POST = withApiRouteEntries(
  CoreApiRoutes.notifications.read.handler(async (request: Request) => {
    ...
    const updatedCount = await markNotificationsReadForUser({
