  ...
  const fallbackPage = (
    ...
    >
        {templates.length === 0 ? (
          ...
          <TemplateTable area="admin" route="/admin/subscriptions">
            <TableHeader>
              <TableRow>
                <TableHead>
            ...
            <TableBody>
              {templates.map((template) => {
                ...
                const publicFeaturesCount = template.features.filter(
                      ...
                      {resolveTableCellSlot({
                        ...
                        fallback: (
                          <Button asChild variant="ghost" size="sm">
                            <Link href={`/admin/subscriptions/${template.id}/edit`}>
