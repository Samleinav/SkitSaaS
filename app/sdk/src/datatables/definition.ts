...
export type BuildTableColumnKey<TItem extends Record<string, unknown>> =
  | keyof TItem
  | string;

export type BuildTableActionButtonType = 'button' | 'submit' | 'reset';
export type BuildTableRequestMethod =
  | 'GET'
  | 'POST'
  | 'PUT'
  | 'PATCH'
...
export type BuildTableLinkActionDefinition =
  BaseBuildTableActionDefinition & {
    kind: 'link';
    href: string;
    target?: string;
    rel?: string;
...
export type BuildTableButtonActionDefinition =
  BaseBuildTableActionDefinition & {
    kind: 'button';
...
export type BuildTableRequestActionDefinition =
  BaseBuildTableActionDefinition & {
    kind: 'request';
    disabled?: boolean;
...
export type BuildTableActionDefinition =
...
export type BuildTableToolbarSearchDefinition<
...
export type ComposeBuildTableDefinitionOptions<
  TItem extends Record<string, unknown>
> = Partial<BuildTableDefinition<TItem>>;

export type ComposedBuildTableDefinition<
  TItem extends Record<string, unknown>,
  TDefinition extends BuildTableDefinition<TItem> = BuildTableDefinition<TItem>
> = TDefinition &
  Pick<
    BuildTableDefinition<TItem>,
    | 'data'
    | 'columns'
    | 'labels'
    | 'className'
...
export function defineBuildTable<
  TItem extends Record<string, unknown>,
  TDefinition extends BuildTableDefinition<TItem>
>(definition: TDefinition) {
  return definition;
}

export function composeBuildTableDefinition<
  TItem extends Record<string, unknown>,
  TDefinition extends BuildTableDefinition<TItem>
>(
  definition: TDefinition,
  options: ComposeBuildTableDefinitionOptions<TItem>
): ComposedBuildTableDefinition<TItem, TDefinition> {
  return {
    ...definition,
    ...options,
...
export function withBuildTableData<
  TItem extends Record<string, unknown>,
  TDefinition extends BuildTableDefinition<TItem>
>(definition: TDefinition, data: TItem[]) {
  return composeBuildTableDefinition(definition, {
    data
  });
}

export function withBuildTableQuery<
  TItem extends Record<string, unknown>,
  TDefinition extends BuildTableDefinition<TItem>
>(definition: TDefinition, query: BuildTableQueryState) {
  return composeBuildTableDefinition<TItem, TDefinition>(definition, {
    query
  });
}

export const buildTableColumn = {
  text<TItem extends Record<string, unknown>>(
    column: BuildTableColumn<TItem>
  ) {
    return column;
  },
  actions<TItem extends Record<string, unknown>>(
    column: BuildTableColumn<TItem>
  ) {
    return column;
  },
  custom<TItem extends Record<string, unknown>>(
    column: BuildTableColumn<TItem>
  ) {
    return column;
  }
...
export const buildTableFilter = {
  text<TItem extends Record<string, unknown>>(
    ...
    return {
      kind: 'text',
      ...filter
    } satisfies BuildTableFilterDefinition<TItem>;
  },
  select<TItem extends Record<string, unknown>>(
    filter: BuildTableFilterDefinition<TItem>
  ) {
    return {
      kind: 'select',
...
export const buildTableAction = {
  link(
    action: Omit<BuildTableLinkActionDefinition, 'kind'>
  ): BuildTableLinkActionDefinition {
    return {
      kind: 'link',
      ...action
  ...
  button(
    action: Omit<BuildTableButtonActionDefinition, 'kind'>
  ): BuildTableButtonActionDefinition {
    return {
      kind: 'button',
      type: 'button',
  ...
  request(
    action: Omit<BuildTableRequestActionDefinition, 'kind'>
  ): BuildTableRequestActionDefinition {
    return {
      kind: 'request',
      ...action
  ...
  custom(
    action: Omit<BuildTableCustomActionDefinition, 'kind'>
  ): BuildTableCustomActionDefinition {
    return {
      kind: 'custom',
      ...action
