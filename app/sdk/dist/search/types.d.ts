...
export type SearchDashboardContextType = 'system_admin' | 'team_member' | 'standalone' | 'public';
...
export type SearchProvider = {
    ...
    search: ((context: SearchContext) => SearchProviderResult | SearchProviderResult[] | Promise<SearchProviderResult | SearchProviderResult[]>) | ((context: SearchContext) => Promise<SearchProviderResult[] | SearchProviderResult>);
};
