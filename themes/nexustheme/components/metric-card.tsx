  ...
  return (
    <div
      className={mergeClassNames(
        '@container/card overflow-hidden rounded-2xl border border-border/70 shadow-sm',
        variant === 'gradient'
    ...
    >
      <div className="flex flex-col gap-3 p-5 sm:p-6">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {(trend || badge) && (
            <div className="flex shrink-0 items-center gap-1.5 rounded-full border border-border/70 bg-background/50 px-2.5 py-1 text-xs font-medium">
              {trend ? (
                <>
        ...
        {/* Footer */}
        {footer && (
          <div className="flex flex-col gap-1 border-t border-border/40 pt-3 text-sm">
            {footer.primary && (
...
export function NexusSimpleMetricCard({
  ...
  return (
    <div
      className={mergeClassNames(
        'overflow-hidden rounded-2xl border border-border/70 p-5 shadow-sm',
        variant === 'gradient'
          ? 'bg-gradient-to-t from-primary/5 to-card dark:bg-card'
          : 'bg-card',
        className
